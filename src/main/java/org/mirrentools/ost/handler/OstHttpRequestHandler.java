...
public interface OstHttpRequestHandler {
    ...
    static void request(HttpClient httpClient, OstRequestOptions options, Handler<AsyncResult<HttpClientResponse>> handler) {
        try {
            String requestUri = options.getRequestUri();
